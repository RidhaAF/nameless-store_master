...
<section id="product">
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active mt-5">
                <a href="/product/12-pro/"><img src="/img/iphone12-banner.jpg" class="d-block w-100"></a>
            </div>
            <div class="carousel-item mt-5">
                <a href="/product/galaxy-flip-z-5g/"><img src="/img/galaxy_z_flip-banner.jpg" class="d-block w-100"></a>
            </div>
            <div class="carousel-item mt-5">
                <a href="/product/galaxy-z-fold-2/"><img src="/img/galaxy_z_fold2-banner.jpg" class="d-block w-100"></a>
            </div>
        </div>
    ...
    <!-- Start About Us -->
    <div class="about bg-dark text-white p-5 mt-5" id="sec-3">
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
